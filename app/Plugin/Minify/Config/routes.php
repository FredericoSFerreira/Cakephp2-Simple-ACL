 ...
 */
	Router::connect('/static-min-js', array('plugin' => 'Minify', 'controller' => 'minify', 'action' => 'index', 'js'));
	Router::connect('/static-min-css', array('plugin' => 'Minify', 'controller' => 'minify', 'action' => 'index', 'css'));