              ...
              <div class="tab-pane" id="home">
                ...
                <div class="panel panel-default">
                  <div class="panel-body">
                    ...
                    echo $this->Form->input('Search.name',array("label"=>"Nombre de Categoria","required"=>false));?>
                        </div>
                    ...
                    echo $this->Form->input('Search.order',array("label"=>"Orden en el menu","required"=>false));?>
                        ...
                        <div class="form-group">
                    <?php echo $this->Form->input('Search.module_id',array("label"=>"Modulos","empty"=>"Seleccione","type"=>"select","required"=>false));
                    ?>
                        </div>
                  </div>
                  <?php
