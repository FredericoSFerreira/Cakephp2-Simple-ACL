                ...
                <tr>
                    ...
                    ?>  
                     <td class="actions">
                        ...
                        if($action == "edit"){
                        echo $this->Html->link('<span class="glyphicon glyphicon-pencil"></span> Editar', '/modules/edit/'.$list['Module']['id'], array('class' => 'btn btn-warning', 'escape' => false)); 
                        }

                         if($action == "delete"){
                        echo $this->Html->link('<span class="glyphicon glyphicon-remove"></span> Eliminar', '/modules/delete/'.$list['Module']['id'], array('class' => 'btn btn-warning deleteitem','data-confirm-title'=>__("Confirmación para eliminar"),'data-confirm-msg'=>__("Deseas eliminar el registro #").$list['Module']['id']." ?", 'escape' => false));
                        }
